...
setup(name='PyZenity',
      ...
      author='Brian Ramos',
      author_email='software@brianramos.com',
      maintainer='Brian Ramos',
      maintainer_email='software@brianramos.com',
      url='http://www.brianramos.com/?page_id=110',
      download_url='http://www.brianramos.com/software/PyZenity/PyZenity-0.1.4.tar.gz',
      license='MIT',
